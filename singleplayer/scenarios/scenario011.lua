local scenariodata = {
	...
	briefing 		= [[You've been tasked to defeat an enemy who is rumored to have four of the tankiest units in the game: the Cortex Behemoths. While they are slow, they spell almost certain doom for your base should they reach it. Your intelligence team has snuck dragon eyes into the enemy base and along the long Speed Metal road to report on the position of these beasts, but are otherwise defenseless against them. Perhaps you must snipe the enemy commander to demoralize their army...
